...
const D: Dict = {
  ...
  facultyPage: { zh: "教师主页", en: "Faculty page" },
  labSite: { zh: "实验室主页", en: "Lab site" },
  ...
  verifyScholar: {
    zh: "以下指标来自 OpenAlex；点击 Scholar 链接可在 Google Scholar 交叉核对。",
    en: "Metrics are sourced from OpenAlex; open the Scholar link to cross-check on Google Scholar.",
  },
